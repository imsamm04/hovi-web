...
import {Form, Icon, Input, InputNumber, Select, Tooltip, Spin} from 'antd';
import GoogleMap from '../../SearchGoogleMap/CheckPinGoogleMap/GoogleMap';
      ...
      <Form {...formItemLayout}>
        ...
        <Form.Item label={<Tooltip placement="topLeft" title="Sử dụng Google Map để dò tìm địa chỉ của bạn">
          ...
          {getFieldDecorator('detailedAddress', {
            initialValue: props.detailedAddress.value,
            rules: [
              {
            ...
            size='large'
            suffix={<Spin spinning={props.isFindAddressLoading}/>}
            placeholder='số nhà, ngách, ngõ, đường,...'/>)}
        </Form.Item>
        <Form.Item colon={false} label=' '>
          <GoogleMap location={props.location} handleFormChange={props.handleFormChange}/>
        </Form.Item>
